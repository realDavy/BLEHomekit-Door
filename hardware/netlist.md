...
文档版本 **1.5**。主控 **ESP32-C3-MINI-1-N4**，门磁锁定 **TMAG5233D1EDBVR**（侧感应，U3，LCSC **C44538511**，立创现货）+ **2N7002** 反相。
...
U1-3, U2-2, U3-1, C2-1, C3-1, C5-1, C7-1, C8-1, R3-1, R5-1, R8-1, R10-1, J1-1
...
```
U3.VCC(1) ── 3V3，C8
U3.OUT(2) ── HALL_OUT ── Q1.G(1)     ← 不要接到 GPIO5
U3.GND(3) ── GND

Q1.S(2) ── GND
Q1.D(3) ── GPIO5 ── U1.IO5(19)      ← 漏极接 GPIO5，禁止接 3V3
                 └── R10 ── 3V3     ← 1 MΩ 上拉在这一侧
